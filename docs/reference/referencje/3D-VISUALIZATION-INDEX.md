...
- `PROJEKTY/3d-object-generation/README.md` — Overview & setup
- `PROJEKTY/3d-object-generation/INTEGRATION.md` — Detailed integration plan
- `PROJEKTY/3d-object-generation/ARCHITECTURE.md` (to be created)
...
→ Read `PROJEKTY/3d-object-generation/INTEGRATION.md` (step-by-step)
...
| `PROJEKTY/3d-object-generation/README.md` | Guide | NVIDIA repo overview |
| `PROJEKTY/3d-object-generation/INTEGRATION.md` | Technical | Step-by-step integration |
...
4. **Plan Integration**
- Read `PROJEKTY/3d-object-generation/INTEGRATION.md`
...
→ See `PROJEKTY/3d-object-generation/INTEGRATION.md` section: "Support & Escalation"
