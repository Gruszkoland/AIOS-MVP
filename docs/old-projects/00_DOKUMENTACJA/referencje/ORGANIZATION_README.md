...
> **Workspace note 2026-05-15:** ten plik przeniesiono do `00_DOKUMENTACJA/referencje/`. Lokalna nawigacja workspace znajduje sie w [PROJECT_INDEX.md](PROJECT_INDEX.md), a root workspace wskazuje na nia przez [README.md](../../README.md).
...
- **[Deployment Guide](../../PROJEKTY/adrion-deploy/README.md)** — Kubernetes & Docker setup
