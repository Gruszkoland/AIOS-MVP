...
|------|---------------|--------|
| `../../20_NARZEDZIA/install-copilot-plugins.ps1` | Automatyczna instalacja | ✅ Created |
...
.\20_NARZEDZIA\install-copilot-plugins.ps1
```
...
```
20_NARZEDZIA\install-copilot-plugins.ps1          (NEW) — Skrypt instalacji
```

### W: `PROJEKTY/162 demencje w schemacie 369\`
```
...
- **Skrypt:** `20_NARZEDZIA/install-copilot-plugins.ps1`
