...
|---------|------|--------|---------------|-------------|
| **162 demencje w schemacie 369** | Core Platform | 🟢 ACTIVE | ~150+ | Last 12h |
| **Consultacja-Wielomodelowa-AI** | Multi-Model API | 🟢 ACTIVE | ~20 | Last 48h |
| **n8n-produkcja** | Workflows | 🟢 ACTIVE | ~15 | Last 72h |
| **adrion-369-architecture** | Documentation | 🟡 STABLE | ~5 | Last 7d |
| **leadgen-comet-pipeline** | Lead Generation | 🟡 STABLE | ~10 | Last 5d |
...
def main():
    ...
    output_dir = Path("c:\\Users\\adiha\\.1_Projekty\\adrion-deploy\\grafana\\provisioning\\dashboards")
