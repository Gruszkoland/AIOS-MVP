...
|---------|--------|---------|------------|
| [162 demencje w schemacie 369](./162%20demencje%20w%20schemacie%20369/README.md) | 🔴 ACTIVE | Main Platform | `docker-compose up -d` |
| [Consultacja-Wielomodelowa-AI](./Consultacja-Wielomodelowa-AI/README.md) | 🟢 ACTIVE | Multi-Model API | `docker-compose up -d` |
| [n8n-produkcja](./n8n-produkcja/README.md) | 🟢 ACTIVE | Workflows | `docker-compose up -d` |

### 📚 Documentation & Reference

| Project | Type | Status |
|---------|------|--------|
| [adrion-369-architecture](./adrion-369-architecture/README.md) | Docs | 📄 Reference |
| [leadgen-comet-pipeline](./leadgen-comet-pipeline/README.md) | Module | 🟡 Stable |
| [embedding-ab-test-framework](./embedding-ab-test-framework/README.md) | Testing | 🟡 Stable |
| [kyc-provider-integration-guide](./kyc-provider-integration-guide/README.md) | Integration | 🟡 Stable |
...
- **Dashboard**: See [DevOps Dashboard](./adrion-deploy/grafana/provisioning/dashboards/devops-dashboard.json)
...
- 📖 [Full Documentation](./adrion-369-architecture/)
...
""".format(
    ...
    index_path = Path("c:\\Users\\adiha\\.1_Projekty\\PROJECT_INDEX.md")
...
def main():
    ...
    print("   - PROJECT_INDEX.md (Main navigation)")
    print("   - [ProjectName]/README.md (Individual projects)")
    print()
    print("🎯 Next Steps:")
    print("   1. Review PROJECT_INDEX.md")
