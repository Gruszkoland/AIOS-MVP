...
rsync -avz --exclude='.venv' --exclude='__pycache__' --exclude='.git' \
  "/c/Users/adiha/.1_Projekty/162 demencje w schemacie 369/" \
  root@<VPS_IP>:/opt/adrion-system/services/adrion/

rsync -avz --exclude='postgres_data' --exclude='.git' \
  "/c/Users/adiha/.1_Projekty/n8n-produkcja/" \
...
|---|---------|-------------------|--------|---------|
| 5.1 | `POSTGRES_PASSWORD` | `openssl rand -base64 24` | `[x]` | `🔐 w n8n-produkcja/.env` |
| 5.2 | `N8N_ENCRYPTION_KEY` | `openssl rand -base64 32` | `[x]` | `🔐 w n8n-produkcja/.env` |
...
| 5.6 | `N8N_BASIC_AUTH_PASSWORD` | Wymyśl silne hasło (min. 16 znaków) | `[x]` | `🔐 w n8n-produkcja/.env` |
| 5.7 | `GRAFANA_ADMIN_PASSWORD` | Wymyśl silne hasło (min. 16 znaków) | `[x]` | `🔐 w n8n-produkcja/.env` |
